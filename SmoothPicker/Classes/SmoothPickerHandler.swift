...
public class SmoothPickerHandler: NSObject, UIScrollViewDelegate
{
                                          ...
                                          targetContentOffset: UnsafeMutablePointer<CGPoint>)
    {
        ...
        let didUseSwipeToSkipCell = handleSwipeScrolling(scrollView,
    ...
    private func handleSwipeScrolling(_ scrollView: UIScrollView,
                                      withVelocity velocity: CGPoint,
                                      targetContentOffset: UnsafeMutablePointer<CGPoint>) -> Bool
    {
